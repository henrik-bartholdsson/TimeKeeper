...
namespace TimeKeeper.Data.Migrations
{
    ...
    [Migration("20210413160347_Adding_CurrentOrganisationId_to_ApplicationUser")]
    partial class Adding_CurrentOrganisationId_to_ApplicationUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int?>("MaximumNumberOfOrganisations")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.Deviation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.DeviationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.Organisation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.Deviation", b =>
                {
                    b.HasOne("TimeKeeper.Data.Models.DeviationType", "DeviationType")
                        .WithMany()
                        .HasForeignKey("DeviationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TimeKeeper.Data.Models.WorkMonth", null)
                        .WithMany("Deviations")
            ...
            modelBuilder.Entity("TimeKeeper.Data.Models.WorkMonth", b =>
                {
                    b.HasOne("TimeKeeper.Data.Models.Organisation", "Organisation")
                        .WithMany()
